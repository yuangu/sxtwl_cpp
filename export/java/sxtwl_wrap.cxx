...
SWIGEXPORT jlong JNICALL Java_com_seantone_sxtwl_sxtwlJNI_new_1Time(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  Time *result = 0 ;
...
SWIGEXPORT jdouble JNICALL Java_com_seantone_sxtwl_sxtwlJNI_toJD(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  ...
  arg1 = *(Time **)&jarg1;
  if (!arg1) {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "Time & reference is null");
    return 0;
  } 
